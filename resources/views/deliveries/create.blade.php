<x-layouts.app>
    <x-slot:title>Tambah Pengiriman</x-slot:title>
    ...
    <div class="mb-8">
        ...
        <h1 class="text-2xl font-semibold text-slate-900">Tambah Pengiriman Baru</h1>
        <p class="mt-1 text-sm text-slate-500">Isi form berikut untuk menambahkan pengiriman baru</p>
    </div>
                ...
                <div>
                    ...
                    <select name="order_id" id="order_id" required
                        ...
                        @foreach ($orders as $orderOption)
                            <option value="{{ $orderOption->id }}" {{ old('order_id') == $orderOption->id ? 'selected' : '' }}>
